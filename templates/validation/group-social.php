...
<div class="ASNERISSEO-function-group">
	...
	<div class="ASNERISSEO-group-summary">
		<?php echo wp_kses_post( ASNERISSEO_Validation::get_status_badge( $social_pass, $social_total ) ); ?>
	...
	<div class="ASNERISSEO-check-item">
		...
		<?php echo wp_kses_post( ASNERISSEO_Validation::get_status_badge( count( $results['og_title'] ) ) ); ?>
		</div>
	...
	<div class="ASNERISSEO-check-item">
		...
		<span class="ASNERISSEO-engine-scope"><?php esc_html_e( 'Platforms: Facebook, LinkedIn', 'asneris-seo-toolkit' ); ?></span>
		<?php echo wp_kses_post( ASNERISSEO_Validation::get_status_badge( count( $results['og_description'] ) ) ); ?>
		</div>
	...
	<div class="ASNERISSEO-check-item">
		...
		<span class="ASNERISSEO-engine-scope"><?php esc_html_e( 'Platforms: Facebook, LinkedIn', 'asneris-seo-toolkit' ); ?></span>
		<?php echo wp_kses_post( ASNERISSEO_Validation::get_status_badge( count( $results['og_image'] ) ) ); ?>
		</div>
	...
	<div class="ASNERISSEO-check-item">
		...
		<?php echo wp_kses_post( ASNERISSEO_Validation::get_status_badge( count( $results['twitter_card'] ) ) ); ?>
		</div>
	...
	<div class="ASNERISSEO-check-item">
		...
		<span class="ASNERISSEO-engine-scope"><?php esc_html_e( 'Platform: X (Twitter)', 'asneris-seo-toolkit' ); ?></span>
		<?php echo wp_kses_post( ASNERISSEO_Validation::get_status_badge( count( $results['twitter_title'] ) ) ); ?>
		</div>
	...
	<div class="ASNERISSEO-check-item">
		...
		<span class="ASNERISSEO-engine-scope"><?php esc_html_e( 'Platform: X (Twitter)', 'asneris-seo-toolkit' ); ?></span>
		<?php echo wp_kses_post( ASNERISSEO_Validation::get_status_badge( count( $results['twitter_description'] ) ) ); ?>
		</div>
