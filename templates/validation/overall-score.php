...
<div class="ASNERISSEO-card" style="margin-top: 20px;">
	...
	<div style="margin: 10px 0;">
		...
		<p style="margin: 5px 0; color: #f0c33c;">
			...
			echo esc_html( sprintf( __( '%d recommended items missing', 'asneris-seo-toolkit' ), $recommended['total'] - $recommended['passed'] ) );
			?>
			</strong>
		</p>
		...
		<p style="margin: 5px 0; color: #666;">
			...
			echo esc_html( sprintf( __( '%d optimization opportunities', 'asneris-seo-toolkit' ), $optimization['total'] - $optimization['passed'] ) );
			?>
			</strong>
		</p>
		<p style="margin: 5px 0; font-size: 13px; color: #666;">
