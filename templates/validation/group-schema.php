...
<div class="ASNERISSEO-function-group">
	...
	<div class="ASNERISSEO-group-summary">
		<?php echo wp_kses_post( ASNERISSEO_Validation::get_status_badge( $schema_pass, $schema_total ) ); ?>
	...
	<div class="ASNERISSEO-check-item">
		...
		<?php if ( ! empty( $results['schema'] ) ) : ?>
			...
			<?php
			foreach ( $results['schema'] as $ASNERISSEO_idx => $ASNERISSEO_schema ) :
			...
			<summary><strong>
					...
					printf( esc_html__( 'Block %d:', 'asneris-seo-toolkit' ), esc_html( $idx + 1 ) );
					?>
			</strong> <?php echo esc_html( $type ); ?></summary>
