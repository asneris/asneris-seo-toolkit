...
<div class="cfseo-function-group">
  <div class="cfseo-group-header" data-group="schema">
    <div class="cfseo-group-title">
      ...
      <h3>⭐ <?php esc_html_e('Rich Results (Structured Data)', 'clarity-first-seo'); ?></h3>
    ...
    <div class="cfseo-group-summary">
      <?php echo esc_html(CFSEO_Validation::get_status_badge($schema_pass, $schema_total); ?>
        <span><?php echo esc_html($schema_pass); ?> / <?php echo esc_html($schema_total); ?> <?php esc_html_e('passed', 'clarity-first-seo'); ?></span>
  ...
  <div class="cfseo-group-content" id="group-schema" style="display: none;">
    <p class="cfseo-group-description">
      <?php esc_html_e('Structured data that enables rich results in search engines', 'clarity-first-seo'); ?>
    </p>
    
    <!-- Schema JSON-LD -->
    <div class="cfseo-check-item">
      <div class="cfseo-check-header">
        <strong><?php esc_html_e('Schema.org JSON-LD', 'clarity-first-seo'); ?></strong>
      ...
      <div class="cfseo-check-details">
        <?php if (!empty($results['schema'])): ?>
          ...
          <details style="margin-top: 10px;">
            ...
            printf(esc_html__('Block %d:', 'clarity-first-seo'), esc_html($idx + 1)); ?></strong> <?php echo esc_html($type); ?></summary>
        ...
        <?php else: ?>
          <p class="description" style="color: #dba617;">
            ⚠ <?php esc_html_e('No Schema.org structured data found', 'clarity-first-seo'); ?>
          </p>
        <?php endif; ?>
      </div>
      <details class="cfseo-technical-details">
        ...
        <div class="cfseo-tech-box">
          ...
          <p><strong><?php esc_html_e('PURPOSE:', 'clarity-first-seo'); ?></strong> <?php esc_html_e('Enables rich results (reviews, events, recipes, etc.) in SERPs', 'clarity-first-seo'); ?></p>
          <p><strong><?php esc_html_e('IMPACT:', 'clarity-first-seo'); ?></strong> <?php esc_html_e('Indirect (medium-high) - Can improve CTR via rich snippets', 'clarity-first-seo'); ?></p>
          <p><strong><?php esc_html_e('VALIDATION:', 'clarity-first-seo'); ?></strong> XPath <code>//script[@type="application/ld+json"]</code>, <?php esc_html_e('JSON parse check', 'clarity-first-seo'); ?></p>
          <p><strong><?php esc_html_e('ALLOWED:', 'clarity-first-seo'); ?></strong> <?php esc_html_e('Multiple blocks are valid. Check for type conflicts (e.g., Product + Article)', 'clarity-first-seo'); ?></p>
          <p><strong><?php esc_html_e('CONFIDENCE LEVEL:', 'clarity-first-seo'); ?></strong> <?php esc_html_e('Medium - Basic syntax validation only. Use Google Rich Results Test for full validation.', 'clarity-first-seo'); ?></p>
        </div>
      </details>
    </div>
  </div>
