...
class ASNERISSEO_Templates {
	 ...
	 */
	public static function parse( $template, $context = array() ) {
		if ( empty( $template ) ) {
			return '';
		}
	...
	public static function get_title_template( $post_type ) {
		$templates = ASNERISSEO_Admin_Settings::get( 'title_templates', array() );
	...
	public static function get_description_template( $post_type ) {
		$templates = ASNERISSEO_Admin_Settings::get( 'description_templates', array() );
		return $templates[ $post_type ] ?? '';
	}
