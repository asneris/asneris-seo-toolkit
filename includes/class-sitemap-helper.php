    ...
    <div class="cfseo-info-box <?php echo esc_attr($box_class); ?>">
      ...
      <div style="background: #e7f5fe; border-left: 4px solid #00a0d2; padding: 12px 15px; margin: 15px 0;">
        <p style="margin: 0 0 8px; font-weight: 600; color: #23282d;">
          ...
          <?php _e('Before Submitting Your Sitemap:', 'cfseo'); ?>
        </p>
        <ol style="margin: 0 0 0 20px; line-height: 1.7; color: #50575e;">
          <li><?php _e('Create a free account with Google Search Console and/or Bing Webmaster Tools', 'cfseo'); ?></li>
          <li><?php _e('Complete site verification first (use codes from the Verification tab)', 'cfseo'); ?></li>
          <li><?php _e('After verification is confirmed, submit your sitemap URL through their tools', 'cfseo'); ?></li>
        </ol>
      </div>
      
      <p><strong><?php _e('Submit Your Sitemap Here:', 'cfseo'); ?></strong></p>
