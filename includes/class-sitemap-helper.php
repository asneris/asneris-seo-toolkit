  ...
  public static function render_sitemap_info() {
    ...
    <div class="cfseo-info-box <?php echo esc_attr($box_class); ?>">
      <h3>
        ...
        <?php esc_html_e('XML Sitemap', 'clarity-first-seo'); ?>
        <?php CFSEO_Help_Modal::render_help_icon('sitemap-info', 'XML Sitemap'); ?>
      </h3>
      <p>
        <?php esc_html_e('WordPress automatically generates an XML sitemap for your site.', 'clarity-first-seo'); ?>
      </p>
      <p>
        <strong><?php esc_html_e('Sitemap URL:', 'clarity-first-seo'); ?></strong><br>
        ...
        <a href="<?php echo esc_url($status['url']); ?>" target="_blank" class="button button-small">
          ...
          <?php esc_html_e('View Sitemap', 'clarity-first-seo'); ?>
        </a>
      </p>
      ...
      <div style="background: #e7f5fe; border-left: 4px solid #00a0d2; padding: 12px 15px; margin: 15px 0;">
        <p style="margin: 0 0 8px; font-weight: 600; color: #23282d;">
          ...
          <?php esc_html_e('Before Submitting Your Sitemap:', 'clarity-first-seo'); ?>
        </p>
        <ol style="margin: 0 0 0 20px; line-height: 1.7; color: #50575e;">
          <li><?php esc_html_e('Create a free account with Google Search Console and/or Bing Webmaster Tools', 'clarity-first-seo'); ?></li>
          <li><?php esc_html_e('Complete site verification first (use codes from the Verification tab)', 'clarity-first-seo'); ?></li>
          <li><?php esc_html_e('After verification is confirmed, submit your sitemap URL through their tools', 'clarity-first-seo'); ?></li>
        </ol>
      </div>
      
      <p><strong><?php esc_html_e('Submit Your Sitemap Here:', 'clarity-first-seo'); ?></strong></p>
      <ul style="margin: 8px 0 0 20px; line-height: 1.8;">
        <li>
          ...
          → <?php esc_html_e('Sitemaps section', 'clarity-first-seo'); ?>
        </li>
        <li>
