    ...
    <div class="wrap ASNERISSEO-admin-wrap">
      ...
      <div class="ASNERISSEO-card">
        ...
        <ul style="line-height: 2;">
          <li>Γ£à Detects technical SEO signals on your pages</li>
          <li>Γ£à Identifies conflicts and ambiguities</li>
          <li>Γ£à Explains why clarity matters</li>
          <li>Γ£à Helps prevent accidental SEO misconfiguration</li>
          <li>Γ£à Provides safe redirect management</li>
          <li>Γ£à Validates robots.txt syntax</li>
        </ul>
      </div>
      ...
      <div class="ASNERISSEO-card">
        ...
        <ul style="line-height: 2;">
          <li>Γ¥î Does NOT promise higher rankings</li>
          <li>Γ¥î Does NOT provide SEO scores or grades</li>
          <li>Γ¥î Does NOT predict algorithm behavior</li>
          <li>Γ¥î Does NOT track backlinks or competitors</li>
          <li>Γ¥î Does NOT rewrite your content with AI</li>
          <li>Γ¥î Does NOT analyze keyword density</li>
          <li>Γ¥î Does NOT guarantee traffic or conversions</li>
          <li>Γ¥î Does NOT submit data to third-party services without consent</li>
        </ul>
      </div>
      ...
      <div class="ASNERISSEO-card">
        ...
        <p><strong>≡ƒº¬ This is beta software.</strong> Features and behavior may change.</p>
        
        <p><strong>Need help or found a bug?</strong></p>
        <ul>
          <li>≡ƒÉ¢ Report issues: <a href="https://github.com/asneris/asneris-seo-toolkit/issues" target="_blank">GitHub Issues</a></li>
        </ul>
      </div>
      ...
      <div class="ASNERISSEO-card" style="background: #f6f7f7; border-left: 4px solid #2271b1;">
        ...
        <p style="font-size: 16px; line-height: 1.8;">
          ...
          This plugin helps you validate that clarityΓÇönothing more, nothing less.
        </p>
