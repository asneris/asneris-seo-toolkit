...
class ASNERISSEO_Data_Interface_Normalizer {
	...
	public static function normalize_overview_item( array $item, array $source_meta = array() ) {
		$raw = array(
	...
	public static function normalize_post_seo( array $payload, array $source_meta = array() ) {
		...
		return self::with_envelope( $raw, array(), $field_states, $source_meta );
	}

	public static function normalize_diagnostics_payload( array $payload, array $source_meta = array() ) {
