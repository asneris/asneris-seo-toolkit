...
// Plugin constants
define('ASNERISSEO_VERSION', '0.1.4');
...
class ASNERISSEO_Bootstrap {
  ...
  public static function register_hooks() {
    ...
    add_action( 'rest_api_init',            [ __CLASS__, 'on_rest_api_init' ] );
  ...
  public static function on_admin_enqueue_scripts( $hook ) {
    ...
    if ( ! wp_style_is( 'ASNERISSEO-admin-menu-icon-visibility', 'enqueued' ) ) {
      wp_register_style( 'ASNERISSEO-admin-menu-icon-visibility', false, [], ASNERISSEO_VERSION );
